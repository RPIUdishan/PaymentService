...
//						wt = c.target("http://localhost:8093/UserAuthifiation/Authifiation").path("usersAuth");
...
//						wt = c.target("http://localhost:8093/UserAuthifiation/Authifiation").path("usersAuth");
//					} else {
//						wt = c.target("http://localhost:8093/UserAuthifiation/Authifiation").path("usersAuth/deny");
//					}
//
